			...
			<table>
				<tr>
					<td colspan="3">
						...
						value='<c:out value="${produto.codigoProduto }"/>'
				...
				<tbody>
					<c:forEach var="p" items="${produtos }">
						<tr>
							...
							<td>${p.nome}</td>
							<td>${p.valor }</td>
							<td><a href="produto?acao=editar&codigoProduto=${p.codigoProduto }">EDITAR</a></td>
							<td><a href="produto?acao=excluir&codigoProduto=${p.codigoProduto }">EXCLUIR</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
